...
const CreateJobCategory = () => {
  ...
  const onSubmit = async (data) => {
    ...
    let value = {
      "jobCategoryTitle": data.name
    }
    const res = await callApi('/jobcategories/createcategory', 'post', value);
        ...
        <div className='row p-11'>
          <div className='col-12 mb-6'>
            ...
            <header className='py-4'>
              <h2 className='font-semibold text-slate-800'>Add new Job Category</h2>
            </header>
          </div>
