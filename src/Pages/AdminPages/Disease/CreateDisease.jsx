...
const schema = yup.object({
  ...
  added: yup.string().required('Disease Type is Required'),
});
...
const CreateDisease = () => {
  ...
  const onSubmit = async (data) => {
    ...
    let value = {
      ...
      diseaseType: data.added
    };
    const res = await callApi('/diseases/createDisease', 'post', value);
        ...
        <div className='row p-11'>
          <div className='col-12 mb-6'>
            ...
            <header className='py-4'>
              <h2 className='font-semibold text-slate-800'>Add new Disease</h2>
            </header>
          </div>
          ...
          <div className='col-lg-6 mb-4 relative'>
            <label className="block text-sm font-medium mb-1" htmlFor="city">Disease Type</label>
            ...
            <select
              ...
              name="added"
              id="added"
              className={`border p-[10px] lg:-mt-[1px] focus:outline-blue-500 rounded-sm w-full   ${errors.added && 'border-red-500'}`}
            >
