...
import ViewEditAppointment from '../../../components/Popups/ViewEditAppointment';
...
const Appointments = () => {
  ...
  return (
    <div className='bscontainer-fluid'>
      <ViewEditAppointment id="job-modal" data={inspireRow} mode={inspireMode} modalOpen={inspirePopup} onClose={() => setinspirePopup(false)} />
      ...
      <div className='row py-5'>
        <div className='col-12  mb-5'>
          ...
          <Link to="create-appointment" className="p-2 flex items-center rounded-sm w-[20%] bg-red-500 hover:bg-green-600 text-white" >
        ...
        <button className="text-slate-400 hover:text-slate-500 rounded-full" onClick={(e) => openInspirePopup(e, "view", "data")}>
        ...
        <div className='col-12 border'>
          <div className="bg-white shadow-lg rounded-sm border border-slate-200 relative">
            <header className="px-5 py-4">
              <h2 className="font-semibold text-slate-800">All Appointments <span className="text-slate-400 font-medium">{allInspires?.length}</span></h2>
            </header>
          </div>
          <div>
