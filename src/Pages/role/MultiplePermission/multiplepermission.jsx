        ...
        (async () => {
            try {
              ...
              let payload ={
                ...
                setallrols(response.data.permissions)
            } catch (error) {
                console.log(error);
            }
        })();
                ...
                <div className='col-12  mb-5'>
                    <div className='mb-3'>
                        <ul className="inline-flex flex-wrap text-sm font-medium">
                            ...
                            <li className="flex items-center">
                                <div className="text-slate-500 hover:text-indigo-500">Multiple Permission</div>
                            </li>
                        </ul>
                    </div>
                    {/* <Link to="create-permission" className="btn bg-red-500 hover:bg-green-600 text-white" >
...
export default MutiplePermission