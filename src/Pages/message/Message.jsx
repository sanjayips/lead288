                    ...
                    <div className="flex flex-col flex-auto h-full p-6">
                        ...
                        >
                                    ...
                                    <div className="grid grid-cols-12 gap-y-2">
                                        <div className="col-start-1 col-end-8 p-3 rounded-lg">
                                            <div className="flex flex-row items-center">
                                                <div
                                                    className="flex items-center justify-center h-10 w-10 rounded-full bg-[#F79F15] flex-shrink-0"
                                                >
                                                    A
                                                </div>
                                                <div
                                        ...
                                        <div className="col-start-6 col-end-13 p-3 rounded-lg">
                                            <div className="flex items-center justify-start flex-row-reverse">
                                                ...
                                                <div
                                                    className="relative mr-3 text-sm bg-[#F7E6CB] py-2 px-4 shadow rounded-xl"
                                                >
                            ...
                            >
                                ...
                                <div className="ml-4">
                                    <button
                                        className="flex items-center justify-center bg-[#F79F15] hover:bg-indigo-600 rounded-xl text-white px-4 py-1 flex-shrink-0"
                                    >
                                        <span>Send</span>
                                        <span className="ml-2">
                                            <svg
