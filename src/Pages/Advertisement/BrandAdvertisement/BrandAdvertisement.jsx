                ...
                <div className='mb-5 col-12'>
                    <div className='mb-3'>
                        <ul className="inline-flex flex-wrap text-sm font-medium">
                            ...
                            <li className="flex items-center">
                                <Link to="/brand-advertisement" className="text-slate-500 hover:text-indigo-500" href="#0">brand</Link>
                            </li>
                        </ul>
                    </div>
                    <Link to="create-brand-advertisement" className="p-2 flex w-[20%] items-center rounded-sm bg-red-500 hover:bg-green-600 text-white" >
                        ...
                        <span className="ml-2">Create Brand</span>
                    </Link>
                </div>
                <div className='border col-12'>
                    <div className="relative bg-white border rounded-sm shadow-lg border-slate-200">
                        <header className="px-5 py-4">
                            <h2 className="font-semibold text-slate-800">All Brands <span className="font-medium text-slate-400">{allbrands.length}</span></h2>
                        </header>
                        <div>
