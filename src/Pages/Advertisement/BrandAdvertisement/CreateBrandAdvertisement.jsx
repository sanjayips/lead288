...
const CreateBrandAdvertisement = () => {
                ...
                <div className='row p-11'>
                    <div className='mb-6 col-12'>
                        <header className="py-4">
                            <h2 className="font-semibold text-slate-800">Add new Brand Advertisement</h2>
                        </header>
                    </div>
                    <div className='relative mb-4 col-lg-3'>
                        <label className="block mb-1 text-sm font-medium" htmlFor="name">Brand name</label>
...
export default CreateBrandAdvertisement