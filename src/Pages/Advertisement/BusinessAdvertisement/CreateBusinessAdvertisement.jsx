...
const CreateBusinessAdvertisement = () => {
                ...
                <div className='row p-11'>
                    <div className='mb-6 col-12'>
                        <header className="py-4">
                            <h2 className="font-semibold text-slate-800">Add new Business Advertisement</h2>
                        </header>
                    </div>
...
export default CreateBusinessAdvertisement